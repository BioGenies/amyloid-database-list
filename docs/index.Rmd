...
- link to the paper (if applicable) (**DOI** column),
...
- what kind of data do they store (**Type of data** column)
- current status of database (**Current status**)

Then, we checked if the links to the databases provided in the articles were still working and if they function correctly. Otherwise, we tried to find the link either through a search engine search or by contacting the database developers. 
